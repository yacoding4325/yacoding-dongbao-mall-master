package com.yacoding.yacodingdongbaogeverator;
...
public class DongbaoGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("G:\\yacoding-dongbao-mall-master\\yacoding-dongbao-service\\yacoding-dongbao-ums\\src\\main\\java");
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/yacoding_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
		...
		pc.setParent("com.yacoding.yacodingdongbaoums");
		pc.setEntity("entity");
		pc.setMapper("mapper");
